...
const songs = [
  {
    ...
    title: 'シャイニングスター',
    artist: '詩歩',
    coverUrl: `${import.meta.env.BASE_URL}shining_star.jpg`,
    musicUrl: `${import.meta.env.BASE_URL}shining_star.mp3`,
  },
  {
    id: 2,
    title: 'Burning Heart',
    artist: 'KEI',
    coverUrl: `${import.meta.env.BASE_URL}burning_heart.jpg`,
    musicUrl: `${import.meta.env.BASE_URL}burning_heart.mp3`,
  },
  {
    id: 3,
    title: '12345',
    artist: 'Mary',
    coverUrl: `${import.meta.env.BASE_URL}12345.jpg`,
    musicUrl: `${import.meta.env.BASE_URL}12345.mp3`,
  },
  {
    id: 4,
    title: 'ハルジオン',
    artist: 'KEI',
    coverUrl: `${import.meta.env.BASE_URL}halzion.jpg`,
    musicUrl: `${import.meta.env.BASE_URL}halzion.mp3`,
  },
  {
    id: 5,
    title: 'Bipolar Disorder Outside var.',
    artist: '森田交一',
    coverUrl: `${import.meta.env.BASE_URL}outside.jpg`,
    musicUrl: `${import.meta.env.BASE_URL}outside.mp3`,
  },
]
